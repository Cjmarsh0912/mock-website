...
export default function Home() {
  return (
    <main>
      <div className='bg-color-light-red'>
        <section className='header'>
          <div className='pic'>
            <img src={oreo_cupcake} />
          </div>
          <div className='desc'>
      ...
      <section className='recent-posts'>
        <div className='intro'>
          ...
          <p>
            ...
            fugiat! Quisquam itaque delectus quidem obcaecati debitis asperiores
            maxime, laborum voluptas explicabo, porro ducimus blanditiis
            excepturi ex.
          </p>
        </div>
        <div className='posts'>
